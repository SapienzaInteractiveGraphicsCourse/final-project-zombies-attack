 ...
 */
var idlePosition = new Vector3(1, -0.09, 0);
 ...
 */
const _animWalk_frames = [0, 20, 27, 37, 50];
const walkEase = new QuadraticEase();
walkEase.setEasingMode(EasingFunction.EASINGMODE_EASEINOUT);

const _animWalk_meshY_bab = new Animation("animWalk_meshY", "position.y", 30, Animation.ANIMATIONTYPE_FLOAT);
...
const _animWalk_move_bab = new Animation("animWalk_move", "rotationQuaternion", 30, Animation.ANIMATIONTYPE_QUATERNION);
_animWalk_move_bab.setEasingFunction(walkEase);
const _animWalk_move_keys = [
    {
        frame:_animWalk_frames[0],
...
const animWalk_move = new MYANIM.Animation(_animWalk_move_bab, _animWalk_move_keys);

const _animWalk_spine_bab = new Animation("animWalk_spine", "rotationQuaternion", 30, Animation.ANIMATIONTYPE_QUATERNION);
_animWalk_spine_bab.setEasingFunction(walkEase);
const _animWalk_spine_keys = [
    {
        frame:_animWalk_frames[0],
        value:Quaternion.FromEulerVector(RotationFromDegrees(0, 0, 0))
    }, {
...
const animWalk_spine = new MYANIM.Animation(_animWalk_spine_bab, _animWalk_spine_keys);
...
function walk(meshdata, scene, onAnimationEnd) {
    ...
    MYANIM.directAnimationLoop(scene, meshdata.getNode("move"), [animWalk_move]);
    MYANIM.directAnimationLoop(scene, meshdata.getNode("Bip01_Spine"), [animWalk_spine], onAnimationEnd);
