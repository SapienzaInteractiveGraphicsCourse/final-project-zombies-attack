...
function death(meshdata, scene, onAnimationEnd) {
    ...
    animationGroup.addTargetedAnimation(animDeath_meshY, meshdata.mesh);
    animationGroup.addTargetedAnimation(animDeath_pelvis_1, meshdata.getNode("Base HumanPelvis_01"));

    animationGroup.addTargetedAnimation(animDeath_spine_1, meshdata.getNode("Base HumanSpine1_06"));
    animationGroup.addTargetedAnimation(animDeath_spine_2, meshdata.getNode("Base HumanSpine2_00"));

    animationGroup.addTargetedAnimation(animDeath_neck, meshdata.getNode("Base HumanNeck_08"));
    animationGroup.addTargetedAnimation(animDeath_head, meshdata.getNode("Base HumanHead_09"));

    animationGroup.addTargetedAnimation(animDeath_L_collarbone, meshdata.getNode("Base HumanLArmCollarbone_033"));
    animationGroup.addTargetedAnimation(animDeath_L_upperarm, meshdata.getNode("Base HumanLArmUpperarm_034"));

    animationGroup.addTargetedAnimation(animDeath_R_collarbone, meshdata.getNode("Base HumanRArmCollarbone_015"));
    animationGroup.addTargetedAnimation(animDeath_R_upperarm, meshdata.getNode("Base HumanRArmUpperarm_016"));

    animationGroup.addTargetedAnimation(animDeath_L_thigh, meshdata.getNode("Base HumanLLegThigh_051"));
    animationGroup.addTargetedAnimation(animDeath_L_calf, meshdata.getNode("Base HumanLLegCalf_052"));

    animationGroup.addTargetedAnimation(animDeath_R_thigh,  meshdata.getNode("Base HumanRThigh_02"));
    animationGroup.addTargetedAnimation(animDeath_R_calf, meshdata.getNode("Base HumanRCalf_03"));
